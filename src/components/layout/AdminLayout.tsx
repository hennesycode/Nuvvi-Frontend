...
export function AdminLayout() {
  ...
  const items = user?.is_superuser || user?.admin_role === "superadmin"
    ? [...sidebarItems, { to: "/admin/usuarios", icon: UserCog, label: "Usuarios" }]
    : sidebarItems;
        ...
        {mobileOpen && (
          <>
            ...
            >
              ...
              <div className="p-3 border-t border-[#D9ECFA]">
                <button onClick={logout} className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-sm font-medium text-[#6C8398] hover:text-[#C94455] hover:bg-[#FDE8E8] transition-all">
                  <LogOut size={18} />
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="flex items-center justify-between h-16 px-5 border-b border-[#D9ECFA] bg-white shrink-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2.5 pl-3 border-l border-[#D9ECFA]">
